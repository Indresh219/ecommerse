...
def search_view(request):
    ...
    if query:
        ...
        # Create an empty Q object to perform the AND query on name and description fields
        q_object = Q()
        for word in query_words:
            # Create a Q object for each word to perform the OR query on name and description fields
            word_q_object = Q(name__icontains=word) | Q(description__icontains=word)
            q_object &= word_q_object

        # Perform the final AND query on name and description fields using the Q object
        products = models.Product.objects.filter(q_object)
    else:
        products = models.Product.objects.all()
